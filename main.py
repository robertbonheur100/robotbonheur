...
const SI={
  ...
  macd_bollinger:{l:"📊 MACD+BB",d:"MACD kwa + Bollinger ekstrem.",tags:["MACD 12/26","BB 20/2","mean-rev","conf 78%"]},
  breakout:{l:"💥 Breakout",d:"Donchian 20 periòd breakout + RSI.",tags:["channel 20","momentum","RSI filtre","conf 80%"]},
};
let sel="confluence";
